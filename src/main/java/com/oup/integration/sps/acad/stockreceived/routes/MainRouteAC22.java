...
import com.oup.integration.sps.acad.stockreceived.sap.pojo.StockreceiveddateAC22;


@Component
public class MainRouteAC22 extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		from("direct:ReceivedSAPMessageAC22")
			.routeId("mainRoute")
			...
			.unmarshal(new BindyCsvDataFormat(StockreceiveddateAC22.class))
			
			.log(LoggingLevel.INFO, "com.oup.sps", "Split Started for MM file ${body}")
			...
			.split(body())
				...
				.to("activemq:{{activemq.uk.queuename}}")
